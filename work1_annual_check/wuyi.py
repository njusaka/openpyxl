...
def compare_info(compare_check, compare_annual):
    ...
    compare_check_0_special = re.sub(u'[\u4e00-\u9fa5]', '', compare_check_0) 
    ...
    if (compare_check_0 in compare_annual_0) or (compare_annual_0 in compare_check_0) \
        or (compare_annual_0_special in compare_check_0) or compare_annual_0:
        if compare_check_1 != '':
...
if __name__ =="__main__":
    ...
    # book_check.save(filename = '桥梁动态数据-定期检查（云南云路工程检测有限公司-2020）_wuyi_1.xlsx') 