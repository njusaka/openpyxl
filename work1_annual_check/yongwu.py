...
def compare_info(compare_check, compare_annual):
    ...
    compare_annual_1 = re.sub(pattern, '',compare_annual_1)

    compare_annual_2 = str(compare_annual[2])

    # print("看compare_annual_1是否去掉数字:", compare_check_0, compare_check_1, compare_annual_0, compare_annual_1, compare_annual_2)

    if (compare_check_0 in compare_annual_0) or (compare_annual_0 in compare_check_0) \
        or (compare_check_0_special in compare_annual_0) or compare_annual_2 in compare_check_0:
        if compare_check_1 != '':
...
if __name__ =="__main__":
    ...
    annual_info = ['2020国高网中心桩号', '位置', '2018国高网中心桩号'] 
    annual_info_loc = []
    ...
    book_check.save(filename = '桥梁动态数据-定期检查（云南云路工程检测有限公司-2020）_yongwu_2.xlsx') 