...
def compare_info(compare_check, compare_annual):
    ...
    # #提取括号里的内容
    # if '（'in compare_check_0:
    #     pattern = re.compile(r'[（](.*?)[）]')
    #     temp = re.findall(pattern, compare_check_0)
    #     compare_check_1_special = temp[0]
    ...
    if (compare_check_0 in compare_annual_0) or (compare_annual_0 in compare_check_0) or (compare_check_0_special in compare_annual_0):
        if compare_check_1 != '':
            ...
            #其它， 单幅
                ...
                return 1
            elif compare_check_1 == '单幅' and compare_annual_1 == '跨线桥':
                # print("匹配成功dan", compare_check_0, compare_check_1, compare_annual_0, compare_annual_1)
                return 1
            elif compare_check_0 == 'K2444+892（上跨桥）' and compare_annual_1 == '跨线桥':
                # print("匹配成功上垮桥", compare_check_0, compare_check_1, compare_annual_0, compare_annual_1)
                return 1
            else:
            ...
            return 1
        elif compare_check_0_special == '上跨桥' and compare_annual_1 == '跨线桥':
            # print("匹配成功上垮桥", compare_check_0, compare_check_1, compare_annual_0, compare_annual_1)
            return 1
        else:
...
if __name__ =="__main__":
    ...
    book_check.save(filename = '桥梁动态数据-定期检查（云南云路工程检测有限公司-2020）_chuda_3.xlsx') 